...
const EditProfile = ({ isShowing, toggle, isClosed }) => {
  return isShowing
    ? ReactDOM.createPortal(
        <div>
          ...
          <div className="z-20 justify-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
